...
class SidekiqScheduler::Config
  ...
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/config.rb#62
  def to_hash; end

  private

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/config.rb#86
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/config.rb#76
  def sidekiq_config; end
end

# source://sidekiq-scheduler//lib/sidekiq-scheduler/config.rb#78
...
class SidekiqScheduler::Manager
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/manager.rb#30
  def to_hash; end

  private

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/manager.rb#38
...
class SidekiqScheduler::Scheduler
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#193
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#171
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#153
  def idempotent_job_enqueue(job_name, time, config); end

  # @return [Boolean]
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#234
  ...
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#204
  def reload_schedule!; end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#185
  ...
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#245
  def toggle_all_jobs(new_state); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#239
  def toggle_job_enabled(name); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#214
  ...
  # @return [Boolean]
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#332
  def enabled_queue?(job_queue, queues); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#364
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#360
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#291
  def schedule_state(name); end

  # Returns the value of attribute scheduler_config.
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#261
  def scheduler_config; end
  ...
  #
  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#301
  def set_schedule_state(name, state); end

  # source://sidekiq-scheduler//lib/sidekiq-scheduler/scheduler.rb#279
...
class SidekiqScheduler::SidekiqAdapter
  class << self
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#21
    def check_using_old_sidekiq_scheduler_config!(sidekiq_config); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#9
    def fetch_scheduler_config_from_sidekiq(sidekiq_config); end

    # @return [Boolean]
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#71
    def redis_key_exists?(key_name); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#81
    def redis_zrangebyscore(key, from, to); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#57
    def sidekiq_queues(sidekiq_config); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#39
    def start_schedule_manager(sidekiq_config:, schedule_manager:); end

    # source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#49
...
# source://sidekiq-scheduler//lib/sidekiq-scheduler/sidekiq_adapter.rb#7
SidekiqScheduler::SidekiqAdapter::SIDEKIQ_GTE_7_3_0 = T.let(T.unsafe(nil), FalseClass)
...
module SidekiqScheduler::Utils
  class << self
    ...
    # @return [Boolean]
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#79
    ...
    # @return [Time]
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#157
    def calc_cron_run_time(cron, time); end

    # Enqueues the job using the ActiveJob.
    #
    # @param config [Hash] The job configuration
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#94
    ...
    # @param config [Hash] The job configuration
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#87
    ...
    def initialize_active_job(klass, args, keyword_argument = T.unsafe(nil)); end

    # Creates a new instance of rufus scheduler.
    #
    # @return [Rufus::Scheduler] the scheduler instance
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#114
    ...
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#107
    ...
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#141
    ...
    #
    # source://sidekiq-scheduler//lib/sidekiq-scheduler/utils.rb#129
