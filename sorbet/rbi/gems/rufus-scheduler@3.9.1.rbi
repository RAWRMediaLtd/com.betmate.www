...
class Rufus::Scheduler
  ...
  # source://rufus-scheduler//lib/rufus/scheduler.rb#741
  def ltstamp; end

  # source://rufus-scheduler//lib/rufus/scheduler.rb#740
  def monow; end
...
# source://rufus-scheduler//lib/rufus/scheduler/jobs_one_time.rb#39
class Rufus::Scheduler::AtJob < ::Rufus::Scheduler::OneTimeJob
  # @return [AtJob] a new instance of AtJob
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_one_time.rb#41
  def initialize(scheduler, time, opts, block); end
end

# source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#263
class Rufus::Scheduler::CronJob < ::Rufus::Scheduler::RepeatJob
  # @return [CronJob] a new instance of CronJob
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#267
  def initialize(scheduler, cronline, opts, block); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#291
  def brute_frequency; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#276
  def check_frequency; end

  # Returns the value of attribute cron_line.
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#265
  def cron_line; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#301
  def next_time_from(time); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#296
  def rough_frequency; end

  protected

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#308
...
#
# source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#155
class Rufus::Scheduler::EvInJob < ::Rufus::Scheduler::RepeatJob
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#157
  def first_at=(first); end
end

# source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#163
class Rufus::Scheduler::EveryJob < ::Rufus::Scheduler::EvInJob
  # @return [EveryJob] a new instance of EveryJob
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#169
  def initialize(scheduler, duration, opts, block); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#183
  def check_frequency; end

  # Returns the value of attribute frequency.
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#165
  def frequency; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#191
  def next_time_from(time); end

  # Returns the value of attribute resume_discard_past.
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#167
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#198
  def set_next_time(trigger_time, is_post = T.unsafe(nil), now = T.unsafe(nil)); end
end
...
# source://rufus-scheduler//lib/rufus/scheduler/jobs_one_time.rb#50
class Rufus::Scheduler::InJob < ::Rufus::Scheduler::OneTimeJob
  # @return [InJob] a new instance of InJob
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_one_time.rb#52
  def initialize(scheduler, duration, opts, block); end
end

# source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#219
class Rufus::Scheduler::IntervalJob < ::Rufus::Scheduler::EvInJob
  # @return [IntervalJob] a new instance of IntervalJob
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#223
  def initialize(scheduler, interval, opts, block); end

  # Returns the value of attribute interval.
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#221
  def interval; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#237
  def next_time_from(time); end

  protected

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#244
  def set_next_time(trigger_time, is_post = T.unsafe(nil), now = T.unsafe(nil)); end
end
...
class Rufus::Scheduler::Job
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#172
  def [](key); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#167
  def []=(key, value); end
  ...
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#205
  ...
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#117
  def check_frequency; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#185
  def entries; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#183
  def keys; end

  # Kills all the threads this Job currently has going on.
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#152
  def kill; end
  ...
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#196
  ...
  # @return [Boolean]
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#157
  def running?; end

  # @return [Boolean]
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#162
  def scheduled?; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#145
  def threads; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#122
  ...
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#135
  def trigger_off_schedule(time = T.unsafe(nil)); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#140
  def unschedule; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#184
  def values; end

  protected

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#212
  def callback(meth, time); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#222
  ...
  # @return [Boolean]
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#379
  def discard_past?; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#236
  def do_call(time, do_rescue); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#255
  def do_trigger(time); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#231
  def mutex(m); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#304
  def post_trigger(time); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#312
  def start_work_thread; end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#275
  def trigger_now(time); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_core.rb#362
...
class Rufus::Scheduler::OneTimeJob < ::Rufus::Scheduler::Job
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_one_time.rb#21
...
class Rufus::Scheduler::RepeatJob < ::Rufus::Scheduler::Job
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#107
  def determine_id; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#36
  def first_at=(first); end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#58
  ...
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#144
  def next_times(count); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#116
  def occurrences(time0, time1); end

  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#91
  def pause; end

  # @return [Boolean]
  #
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#102
  def paused?; end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#96
  def resume(opts = T.unsafe(nil)); end
  ...
  # source://rufus-scheduler//lib/rufus/scheduler/jobs_repeat.rb#76
  def trigger(time); end
end
