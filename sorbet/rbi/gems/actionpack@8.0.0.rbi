...
ActionDispatch::ParamBuilder::LEADING_BRACKETS_COMPAT = T.let(T.unsafe(nil), TrueClass)
...
ActionDispatch::QueryParser::SEMICOLON_COMPAT = T.let(T.unsafe(nil), TrueClass)
